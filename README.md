...
## 博主魔改内容 20200623
1. _includes/head.html 修改font-awesome.min.css文件地址为https://cdn.jsdelivr.cn/。
2. _layouts/page.html 修改地址https://cdn.jsdelivr.cn
3. _includes/footer.html 修改fastclick.min.js文件地址为https://cdn.jsdelivr.cn/。
