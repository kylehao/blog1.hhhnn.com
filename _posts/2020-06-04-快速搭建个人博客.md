...
date:       2020-06-04
author:     BY
header-img: {{ site.baseurl }}/img/post-bg-re-vs-ng2.jpg
catalog: true
tags:
    - Blog
---
...
header-img: {{ site.baseurl }}/img/post-bg-rwd.jpg  	#显示在首页的背景图片
email: You@gmail.com	
...
date:       2017-02-06 				# 时间
author:     BY 						# 作者
header-img: {{ site.baseurl }}/img/post-bg-2015.jpg 	#这篇文章标题背景图片
catalog: true 						# 是否归档
tags:								#标签
    - 生活
---
